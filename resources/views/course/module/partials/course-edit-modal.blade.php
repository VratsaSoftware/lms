        ...
        <div class="modal-dialog modal-sm" style="margin-right: 15px">
            <div class="modal-content">
                ...
                <div class="modal-body text-normal" style="padding-top:0px;">
                    ...
                    <p class="ms-4"><img src="{{ asset('assets/icons/application-green.png') }}" course-settings-icon><a href="{{ route('application-entry-form', encrypt($module->Course->id)) }}" class="ms-2" style="color:#00214b!important;">Кандидатстване</a></p>
