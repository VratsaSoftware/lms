                    ...
                    <div class="nav nav-tabs row align-items-center g-0 mb-4 p-sm-0 pt-3 pb-4">
                        ...
                        <div class="col d-sm-none">
                            <div class="position-relative d-inline-block">
                                <select class="border-0 form-control text-small text-green position-relative ps-0 py-0" id="tab_selector" style="{{ Auth::user()->isStudent() ? 'min-width: 130px;' : 'width: 130px;' }}">
                                    @foreach ($allModules as $moduleNav)
                                        @if (!Auth::user()->isStudent())
