...
@if(!isset($user->picture))
    <img src="https://ui-avatars.com/api/?name={{ $user->name }} {{ $user->last_name }}&color=7F9CF5&background=random" alt="profile-pic" style="{!! $style !!}" class="avatar {!! isset($class) ? $class : '' !!}">
@else
    <img src="{{ asset('images/user-pics/' . $user->picture) }}" alt="profile-pic" style="{!! $style !!}" class="avatar {!! isset($class) ? $class : '' !!}">
@endif
