        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <div class="pt-lg-5">
                <ul class="nav d-block col-12 pb-2">
                    ...
                    @endif
                    <li class="nav-item align-items-center mb-lg-5 @if (request()->routeIs('module*') || request()->routeIs('user.module.lections') || request()->routeIs('courses.index') || (request()->routeIs('profile') && !Auth::user()->isAdmin())) active-link @endif">
