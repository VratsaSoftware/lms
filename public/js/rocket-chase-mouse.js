$( function () {
	...
	$( '#ui-id-1' ).on( 'click', function () {
		...
		$( '.rocket-holder-java' ).css( 'display', 'none !important' );
	...
	$( '#ui-id-2' ).on( 'click', function () {
		...
		$( '.rocket-holder' ).css( 'display', 'none !important' );
	...
	//php
	$( '#tabs-1' ).mousemove( function ( event ) {
		console.log( ( event.pageY - 50 ) );
		// console.log(clicked);
		...
		if ( moving > 53 ) {
			...
			$( '.rocket-holder' ).css( 'margin-top', '' + moving + 'vw' );
			$( '.rocket-holder' ).css( 'transition', 'margin 50ms' );
			// $('.rocket-holder').css('margin-top', moving+'vw');
		}
		// console.log(moving);
		// }
	...
	//java
	$( '#tabs-2' ).mousemove( function ( event ) {
		// console.log(clicked);
		...
		if ( movingJava > 53 ) {
			movingJava = 53;
			flyJava = 1;
			$( '.rocket-holder-java' ).css( 'margin-top', '' + movingJava + 'vw' );
			...
			$( '.rocket-holder-java' ).css( 'margin-top', '' + movingJava + 'vw' );
			$( '.rocket-holder-java' ).css( 'transition', 'margin 50ms' );
			// $('.rocket-holder').css('margin-top', moving+'vw');
		}
		// console.log(moving);
		// }
