...
//                "suitable_candidate" => 'required|min:100|max:500',
            ...
            $job = new CourseApplicationEmail($user->email, $data['course'], $data['test_datetime'] ?? null);
            dispatch($job);
...
//            "suitable_candidate" => 'required|min:100|max:500',
        ...
        $job = new CourseApplicationEmail($newUser->email, $data['course'], $data['test_datetime'] ?? null, $token);
        dispatch($job);
